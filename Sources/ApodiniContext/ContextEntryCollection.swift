...
protocol AnyContextEntryCollection {
    ...
    func copy() -> AnyContextEntryCollection
}
...
class ContextEntryCollection<Key: OptionalContextKey>: AnyContextEntryCollection {
    ...
    private init(entries: [ContextEntry<Key>], modifierEntries: [ContextEntry<Key>]) {
        self.entries = entries
        self.modifierEntries = modifierEntries
    }
    ...
    func copy() -> AnyContextEntryCollection {
        ContextEntryCollection(entries: self.entries, modifierEntries: self.modifierEntries)
    }
